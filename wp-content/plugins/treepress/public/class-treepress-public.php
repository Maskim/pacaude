...
class Treepress_Public
{
    ...
    public function treepress_family_lists( $memberid = '' )
    {
        ...
        $html .= $the_family->get_html( $the_family );
        $html .= '<hr>';
        //}
        return $html;
    }
