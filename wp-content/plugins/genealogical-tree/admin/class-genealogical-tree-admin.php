...
class Genealogical_Tree_Admin
{
    ...
    {
        $t_id = $term->term_id;
        $term_link = get_term_link( $term, 'gt-family-group' );
        $tree_page_id = get_term_meta( $term->term_id, 'tree_page', true );
        $tree_page = get_the_permalink( get_term_meta( $term->term_id, 'tree_page', true ) );
        $tree_list_page_id = get_term_meta( $term->term_id, 'tree_list_page', true );
        $tree_list_page = get_the_permalink( get_term_meta( $term->term_id, 'tree_list_page', true ) );
        $members_page_id = get_term_meta( $term->term_id, 'members_page', true );
        ...
        ?>
				...
				<p class="description"><?php 
        _e( 'The link of family tree page of this group.', 'genealogical-tree' );
        ...
        ?>">Custom Members Page</a> / <a target="_blank" href="<?php 
        echo  $term_link ;
        ?>">Default Members Page</a></p>
			</td>
		</tr>
	<?php 
    }
