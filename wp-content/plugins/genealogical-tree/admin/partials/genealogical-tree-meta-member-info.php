					...
					<td>
						<select id="mother" name="gt[mother]">
							...
							<?php foreach ($mothers as $key => $value) { ?>
								<option <?php if($value==$mother) { echo 'selected'; } ?> value="<?php echo $value; ?>"><?php echo 'ID-'.$value .'-'. get_post_meta($value, 'full_name', true); ?></option>
							<?php } ?>
						</select>
					</td>
				</tr>
					...
					<td>
						<select id="father" name="gt[father]">
							...
							<?php foreach ($fathers as $key => $value) { ?>
								<option <?php if($value==$father) { echo 'selected'; } ?> value="<?php echo $value; ?>"><?php echo 'ID-'.$value .'-'. get_post_meta($value, 'full_name', true); ?></option>
							<?php } ?>
						</select>
					</td>
				</tr>
				...
				<tr class="tr-wife" style="<?php if($sex==='F'){ echo 'display: none;'; } elseif($sex==='M') { echo 'display: table-row;'; } else {echo 'display: table-row;';} ?>">
					...
					<td>
						<?php $y = 0; foreach ( $spouses as $key => $wife) { 
							...
							$wife_to_reson = '';
							if(isset($wife['_to_reson'])){
								$wife_to_reson = $wife['_to_reson'];
							}
							?>
						<div class="repetead-field"> 
							...
							<select id="wife" name="gt[wife][<?php echo $y; ?>][id]">
								...
								<?php foreach ($mothers as $key => $value) {  ?>
									<option <?php if($wife['id']==$value) { echo 'selected'; } ?> value="<?php echo $value; ?>"><?php echo 'ID-'.$value .'-'. get_post_meta($value, 'full_name', true); ?></option>
								<?php } ?>
							</select>
							<div style="margin-left: -3px; margin-right: -3px;">
								<table class="gta-table">
									<tr>
										...
										<td><input type="text" name="gt[wife][<?php echo $y; ?>][from]" value="<?php echo $wife_from; ?>"> </td>
										<td><label for="father">To</label></td>
										<td><input type="text" name="gt[wife][<?php echo $y; ?>][to]" value="<?php echo $wife_to; ?>"> </td>
									</tr>
									<tr>
										...
										<td colspan="2">
											<select name="gt[wife][<?php echo $y; ?>][_to_reson]">
												...
												<option <?php if($wife_to_reson=='divorce') { echo 'selected'; } ?> value="divorce">Divorce</option>
												<option <?php if($wife_to_reson=='death') { echo 'selected'; } ?> value="death">Death</option>
												<option <?php if($wife_to_reson=='other') { echo 'selected'; } ?> value="other">Other</option>
											</select>
										</td>
									</tr>
								</table>
					...
					<td>
						...
						<div class="repetead-field"> 
							...
							<select id="husb" name="gt[husb][<?php echo $x; ?>][id]">
								...
								<?php foreach ($fathers as $key => $value) { ?>
									<option <?php if($husb['id']==$value) { echo 'selected'; } ?> value="<?php echo $value; ?>"><?php echo 'ID-'.$value .'-'. get_post_meta($value, 'full_name', true); ?></option>
								<?php } ?>
							</select>
							<div style="margin-left: -3px; margin-right: -3px;">
								<table class="gta-table">
